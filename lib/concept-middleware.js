	...
	return function(req, res, next){
		if(req.concept && req.concept.name){
			if(req.concept.addName instanceof Function){
				req.concept.addName(req.concept.name, function(err){
					res.err = err;
					next();
				});
			} else if(req.concept.id) {
	...
	return function(req, res, next){
		if(req.concept && req.concept.name){
			if(req.concept.removeName instanceof Function){
				req.concept.removeName(req.concept.name, function(err){
					res.err = err;
					next();
				});
			} else if(req.concept.id) {
	...
	return function(req, res, next){
		if(req.concept && req.concept.desc){
			if(req.concept.addDesc instanceof Function){
				req.concept.addDesc(req.concept.desc, function(err){
					res.err = err;
					next();
				});
			} else if(req.concept.id) {
	...
	return function(req, res, next){
		if(req.concept && req.concept.desc){
			if(req.concept.removeDesc instanceof Function){
				req.concept.removeDesc(req.concept.desc, function(err){
					res.err = err;
					next();
				});
			} else if(req.concept.id) {
